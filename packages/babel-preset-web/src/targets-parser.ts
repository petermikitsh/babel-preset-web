...
const getLowestVersions = (browsers: Array<string>): Targets => {
  return browsers.reduce((all: any, browser: string): Object => {
...
const outputDecimalWarning = (decimalTargets: Array<Object>): void => {
  ...
  console.log("");
  decimalTargets.forEach(({ target, value }: { target: any, value: any }) =>
...
const getTargets = (targets: Object = {}, options: Options = {}): Targets => {
